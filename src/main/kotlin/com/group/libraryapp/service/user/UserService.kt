...
class UserService (
    ...
    fun saveUserAndLoanTwoBooks() {
        ...
        val books = bookRepository.saveAll(listOf(Book("책", BookType.COMPUTER), Book("책",BookType.COMPUTER)))
        books.forEach{ book -> newUser.loanBook(book) } // UserLoanHistory 2개 생김
